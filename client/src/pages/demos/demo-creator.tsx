...
const formSchema = z.object({
  ...
  companyType: z.string().default("content_creator"),
          ...
          <div className="max-w-7xl mx-auto px-6 py-12 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:pr-8">
                ...
                <p className="text-xl text-white/80 mb-8 leading-relaxed">Learn how VadisAI helps individual creators enhance their content with AI-driven scriptwriting and analysis.</p>

                <div className="mb-8">
                  <p className="text-lg font-semibold text-white mb-4">
                    <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent glow-text">Creative professionals</span> use VadisAI to:
                  </p>
