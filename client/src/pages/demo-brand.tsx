...
const industryPartners = [
  { name: "Coca-Cola", icon: SiCocacola, color: "text-red-600", category: "Global Brand" },
  { name: "Nike", icon: SiNike, color: "text-black", category: "Sports Brand" },
  { name: "Apple", icon: SiApple, color: "text-gray-800", category: "Tech Giant" },
  { name: "Google", icon: SiGoogle, color: "text-blue-600", category: "Digital Platform" },
          ...
          <CardContent className="p-12 text-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                ...
                <a href="mailto:sales@vadis.ai" className="text-pink-600 hover:underline font-medium">
                  sales@vadis.ai
                </a>
              </p>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-lg">
            <CardHeader className="pb-6">
              ...
              <p className="text-gray-600">
                See how leading brands and agencies are revolutionizing their content marketing with VadisAI.
              </p>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="email" placeholder="sarah@brandagency.com" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Your Brand or Agency" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Brand Manager, Creative Director, Marketing Lead" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            placeholder="Tell us about your current campaign objectives or brand partnership needs..."
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Brands & Agencies Choose VadisAI</h2>
            ...
            {/* Trusted Partners */}
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Trusted by Global Brands</h3>
              <div className="grid grid-cols-2 gap-4">
