            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:pr-8">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight glow-text">
                  Scale your productions from good to <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">extraordinary.</span>
                </h1>
                ...
                <div className="mb-8">
                  <p className="text-lg font-semibold text-white mb-4">
                    <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent glow-text">Top production companies</span> use VadisAI to:
                  </p>
                ...
                {/* Trust Indicators */}
                <div>
                  <p className="text-sm text-white/60 mb-4">Leading production studios trust VadisAI for their projects</p>
                  <div className="flex items-center space-x-8 opacity-60">
                    <SiNetflix className="w-8 h-8 text-white/40 hover:text-red-400 transition-colors" />
                    <Film className="w-8 h-8 text-white/40 hover:text-yellow-400 transition-colors" />
                    <SiSony className="w-8 h-8 text-white/40 hover:text-blue-400 transition-colors" />
                    <Camera className="w-8 h-8 text-white/40 hover:text-purple-400 transition-colors" />
                    <Clapperboard className="w-8 h-8 text-white/40 hover:text-green-400 transition-colors" />
                  </div>
                </div>
              </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormControl>
                            <Textarea 
                              placeholder="Tell us about your current projects or production needs"
